...
const SAMPLE_ACCOUNTS: BankAccount[] = [
  { id: genId(), accountName: 'Primary Savings', bankName: 'HDFC Bank', accountType: 'Savings', balance: 45000, color: '#3B82F6', icon: 'account-balance' },
  { id: genId(), accountName: 'Salary Account', bankName: 'ICICI Bank', accountType: 'Salary', balance: 12500, color: '#10B981', icon: 'account-balance' },
  { id: genId(), accountName: 'Emergency Fund', bankName: 'SBI', accountType: 'Savings', balance: 80000, color: '#8B5CF6', icon: 'account-balance' },
  { id: genId(), accountName: 'Business Current', bankName: 'Axis Bank', accountType: 'Current', balance: 28000, color: '#F59E0B', icon: 'account-balance' },
];

const SAMPLE_CARDS: CreditCard[] = [
  { id: genId(), cardName: 'Infinia', bankName: 'HDFC Bank', creditLimit: 300000, outstanding: 18500, dueDate: '15 May 2026', color: '#EF4444' },
  { id: genId(), cardName: 'Sapphiro', bankName: 'ICICI Bank', creditLimit: 200000, outstanding: 6200, dueDate: '10 May 2026', color: '#F97316' },
  { id: genId(), cardName: 'Simply Click', bankName: 'SBI', creditLimit: 100000, outstanding: 3100, dueDate: '20 May 2026', color: '#8B5CF6' },
  { id: genId(), cardName: 'Magnus', bankName: 'Axis Bank', creditLimit: 250000, outstanding: 22000, dueDate: '05 May 2026', color: '#3B82F6' },
  { id: genId(), cardName: 'Vistara Prime', bankName: 'SBI Card', creditLimit: 150000, outstanding: 0, dueDate: '25 May 2026', color: '#EC4899' },
  { id: genId(), cardName: 'ACE', bankName: 'AU Bank', creditLimit: 80000, outstanding: 4800, dueDate: '18 May 2026', color: '#10B981' },
];
